...
func main() {
	...
	app.Flags = []cli.Flag{
		...
		cli.StringFlag{
			Name:   "user-ansible-cfg",
			Usage:  "path to an ansible.cfg file relative to repository e.g. ./ansible.cfg",
			EnvVar: "USER_ANSIBLE_CONFIG",
		},
	}
...
func run(c *cli.Context) error {
	plugin := Plugin{
		Config: Config{
			...
			UserAnsibleCfg: c.String("user-ansible-cfg"),
		},
	}
